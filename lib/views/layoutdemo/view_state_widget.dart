...
import 'package:flutter_app/providerutil/view_state.dart';
import 'package:flutter_app/views/layoutdemo/resource_manager.dart';
...
//        defaultTitle = S.of(context).viewStateMessageNetworkError;
        defaultTitle="默认提示文本";
        errorMessage = '网络异常'; // 网络异常移除message提示
        break;
